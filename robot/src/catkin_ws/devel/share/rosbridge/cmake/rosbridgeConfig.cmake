...
if("TRUE" STREQUAL "TRUE")
  set(rosbridge_SOURCE_PREFIX /home/cedric/Desktop/IoT/robot/src/catkin_ws/src/rosbridge)
  set(rosbridge_DEVEL_PREFIX /home/cedric/Desktop/IoT/robot/src/catkin_ws/devel)
  ...
  set(rosbridge_INSTALL_PREFIX /home/cedric/Desktop/IoT/robot/src/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rosbridge' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'cedric <cedric@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'rosbridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cedric/Desktop/IoT/robot/src/catkin_ws/src/rosbridge/${idir}'.  Ask the maintainer 'cedric <cedric@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${rosbridge_dep}_FOUND)
      find_package(${rosbridge_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rosbridge_dep} REQUIRED ${depend_list})
  endif()
